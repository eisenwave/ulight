...
inline constexpr struct Is_JS_Whitespace {
    [[nodiscard]]
...
inline constexpr struct Is_JS_Identifier_Start {
    [[nodiscard]]
...
} is_js_identifier_start;

inline constexpr struct Is_JS_Identifier_Part {
    [[nodiscard]]
    static constexpr bool operator()(const char8_t c)
        = delete;
...
} is_js_identifier_part;

inline constexpr struct Is_JSX_Tag_Name_Part {
    [[nodiscard]]
    static constexpr bool operator()(const char8_t c)
        = delete;
