...
[[nodiscard]]
constexpr bool is_mmml_special(char8_t c)
{
    return is_mmml_special_set.contains(c);
}

[[nodiscard]]
constexpr bool is_mmml_special(char32_t c)
{
...
[[nodiscard]]
constexpr bool is_mmml_ascii_argument_name(char8_t c)
{
    return is_mmml_ascii_argument_name_set.contains(c);
}

[[nodiscard]]
constexpr bool is_mmml_ascii_argument_name(char32_t c)
{
...
[[nodiscard]]
constexpr bool is_mmml_argument_name(char32_t c)
{
...
[[nodiscard]]
constexpr bool is_mmml_ascii_directive_name(char8_t c)
{
    return is_html_ascii_tag_name_character(c);
}

[[nodiscard]]
constexpr bool is_mmml_ascii_directive_name(char32_t c)
{
