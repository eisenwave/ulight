...
[[nodiscard]]
std::size_t match_hashbang_comment(std::u8string_view str, bool is_at_start_of_file = false) noexcept;
...
[[nodiscard]]
std::optional<Token_Type> match_operator_or_punctuation(std::u8string_view str, Lang js_or_jsx);
